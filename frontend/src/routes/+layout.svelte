				...
				<div class="hidden items-center space-x-3 md:flex">
					...
					{:else}
						<a
							...
							class="inline-flex items-center gap-2 rounded-xl border-2 border-yellow-500 bg-transparent px-4 py-2.5 text-sm font-semibold text-yellow-700 shadow-md transition hover:bg-yellow-50 hover:shadow-lg"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								class="h-5 w-5"
